...
/**
 * Убедитесь, что файл существует, или создайте его с значениями по умолчанию
 * @template T - Тип данных для хранения в файле
 * @param {string} filePath - Путь к файлу для проверки и создания
 * @param {T[]} defaultValue - Значение по умолчанию, если файл не существует
 * @returns {void}
 */
...
/**
 * Прочитайте JSON файл и вернете спарсенные данные
 * @template T - Тип данных для парсинга
 * @param {string} filePath - Путь к JSON файлу
 * @param {T[]} [defaultValue=[]] - Значение по умолчанию, если файл пуст или поврежден
 * @returns {T[]} Массив спарсенных данных или значение по умолчанию
 */
...
/**
 * Запишите данные в JSON файл с форматированием
 * @template T - Тип данных для записи
 * @param {string} filePath - Путь к JSON файлу для записи
 * @param {T[]} data - Массив данных для записи в файл
 * @returns {void}
 */
...
/**
 * Получите существующую корзину пользователя или создайте новую
 * @param {number} userId - ID пользователя, для которого нужно получить или создать корзину
 * @returns {{carts: Cart[], cart: Cart}} Объект со всеми корзинами и корзиной конкретного пользователя
 */
